...
export default function TimelinePage() {
  ...
  return (
    <section style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 1180, margin: '0 auto', padding: isMobile ? '18px 16px 60px' : '26px 24px 90px', animation: 'fhFade .4s ease both' }}>
      ...
      <div style={{ position: 'relative', paddingLeft: isMobile ? 28 : 46 }}>
        <div style={{ position: 'absolute', top: 12, bottom: 0, left: isMobile ? 8 : 14, width: 2, background: 'var(--surface2)', overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 48 }}>
          {allEvents.map((e, i) => (
            <div key={i} className="timeline-item" style={{ position: 'relative' }}>
              <div className="timeline-dot" style={{ position: 'absolute', top: 6, left: isMobile ? -26 : -38, width: 14, height: 14, borderRadius: '50%', background: 'var(--surface)', border: '3px solid var(--surface2)', transition: 'all .4s .3s' }} />
